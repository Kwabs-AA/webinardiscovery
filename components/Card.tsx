...
const Card = ({ name, description, _id, link }: Props) => {
  ...
  return (
    <div className="w-full sm:w-72 md:w-80 lg:w-96 xl:w-[26rem] 2xl:w-[28rem] mx-2 my-4 transition-transform duration-300 hover:scale-105">
      <div className="card bg-base-100 shadow-xl aspect-square">
        ...
        <div className="card-body p-4 sm:p-6 h-auto flex flex-col">
