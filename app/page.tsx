...
const Home = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="relative -mt-32 mx-auto w-full px-4 sm:px-6 lg:px-8">
        <div className="bg-base-200 rounded-xl p-8 shadow-lg min-h-[60vh] flex flex-wrap ">
          {categories.map((items:any,index)=>(
              <div key ={index}>
                <Card key={index} name={items.name} description={items.description} link={items.link} _id={items._id} />
              </div>
          ))}
        </div>
      </div>
